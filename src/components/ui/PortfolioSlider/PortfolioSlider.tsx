...
export const PortfolioSlider: FC<PortfolioSliderProps> = ({ numberOfProjects }) => {
  ...
  const processedProjects = useMemo(() => {
    ...
    const limitedProjects = numberOfProjects
      ? reversedProjects.slice(0, numberOfProjects)
      : reversedProjects
  ...
  return (
    <>
      ...
      {activeProject && <ProjectModal project={activeProject} onClose={handleCloseModal} />}
    </>
  )
}
